    ...
    function createConfigSingle($strTableName, $cfgName = '', $intMode = 0, $service = '')
    {
        ...
        switch ($strTableName) {
            ...
            case "tbl_host":
                ...
                $this->getConfigData("hostbackup", $strBackupDir);
                $strSQLData = "SELECT * FROM `".$strTableName."` WHERE `host_name`='$cfgName' AND `config_id`=".$this->intDomainId;
                break;
            ...
            case "tbl_service":
                ...
                $strSQLData = "SELECT * FROM `".$strTableName."` WHERE `config_name`='$cfgName' AND" . $service_query . " `config_id`=".$this->intDomainId." ORDER BY `service_description`";
                break;
        }
