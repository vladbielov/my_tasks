    ...
    if ($intInsert == 1) {
        ...
        if ($chkModus == "insert") {
            ...
            if (!empty($chkSelService)) {
                $ccm->data->dataInsertRelation("tbl_lnk{$ucType}ToService", $chkDataId, $chkSelService);
            }
        ...
        if ($chkModus == "modify") {
            ...
            // Update hosts 
            if (!empty($chkSelHost) && $intSelHost != 2) {
            ...
            // Update hostgroups 
            if (!empty($chkSelHostGroup) && $intSelHostGroup != 2) {
            ...
            // Services 
            if (!empty($chkSelService) && $intSelService != 2) {
                $ccm->data->dataUpdateRelation("tbl_lnk{$ucType}ToService", $chkDataId, $chkSelService);
            } else {
