...
$(document).ready(function () {
    ...
    $('#dashify2').click(function () {
        ...
        content += "<div id='addToDashboardFormButtons' style='margin-top:5px;'><button class='btn btn-sm btn-primary' id='AddToDashButton' onclick='ge_add_formdata()'>" + _('Add It') + "</button></div>";
