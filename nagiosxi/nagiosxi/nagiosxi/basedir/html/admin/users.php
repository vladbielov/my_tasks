            ...
            <table id="usersTable" class="tablesorter table table-striped table-hover table-condensed table-bordered">
                ...
                if (!$rs || $rs->EOF) {
                    ...
                    while (!$rs->EOF) {
                        ...
                        $phone = get_user_meta($oid, 'mobile_number', '');
        ...
        <div class="container-fluid">
            ...
            <table class="editDataSourceTable table table-condensed table-no-border" cellpadding="2">
                <tr>
                    ...
                    <td>
                        <input type="text" size="15" name="username" id="usernameBox" value="<?php echo encode_form_val($username); ?>" <?php if ($username == "nagiosadmin") { echo "readonly"; } ?> class="textfield form-control">
                    </td>
                </tr>
                <tr class="pw">
                    <td>
...
function do_update_user()
{
    ...
    $password2 = trim(grab_request_var("password2", ""));
    $phone = grab_request_var("phone", "");
