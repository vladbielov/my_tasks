    ...
    <table class="table-condensed table-no-border table-auto-width">
        <tbody>
            <tr>
                ...
                <td>
                    <input type="text" class="form-control textfield" id="ls_hostname" name="server[hostname]" value="<?php echo grab_array_var($server, 'hostname', '');?>">&nbsp;
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control textfield" id="ls_port" name="server[port]" size="6" value="<?php echo grab_array_var($server, 'port', 2056);?>">&nbsp;
