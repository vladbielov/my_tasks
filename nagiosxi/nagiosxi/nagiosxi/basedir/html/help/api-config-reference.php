...
?>
        ...
        <div class="row">
            <div class="col-sm-8 col-md-9 col-lg-9">
                ...
                <div class="alert alert-warning" style="margin-top: 0;">
                    <i class="fa fa-exclamation l"></i> <b><?php echo _('Warning'); ?>:</b> <?php echo _('Some objects returned by <b>GET</b> queries may not be applied yet. Use the objects refernnce API when querying for a list of objects that are being monitored.'); ?>
                </div>
        ...
        "contacts OR contact_groups"
                ...
                <div class="help-section obj-reference">
                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            <div class="col-md-5 col-lg-4 col-xl-3">
                                <p><?php echo _('This command updates a host object.'); ?></p>
                                <table class="table table-condensed table-bordered table-hover" style="margin-bottom: 10px;">
                                    <thead>
                                        <tr>
                                            <th><?php echo _('Optional Parameters'); ?></th>
    ...
    "success": "Added testapihost :: PING to the system. Config applied, Nagios Core was restarted."
                ...
                <div class="help-section obj-reference">
                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <p><?php echo _('This command creates or updates a service object. To update, a host_name or config_name must be specified to find the specific service.'); ?></p>
                        <div class="row">
                            <div class="col-md-5 col-lg-4 col-xl-3">
                                <table class="table table-condensed table-bordered table-hover" style="margin-bottom: 10px;">
                                    <thead>
    ...
    "success": "Added testapiservicegroup to the system. Config applied, Nagios Core was restarted."
                ...
                <div class="help-section obj-reference">
                    <h4><span class="label label-success">PUT</span> config/hostgroup <i>or</i> config/hostgroup/&lt;hostgroup_name&gt;</h4>
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            <div class="col-md-5 col-lg-4 col-xl-3">
                                <p><?php echo _('This command updates a current hostgroup.'); ?></p>
                                <table class="table table-condensed table-bordered table-hover" style="margin-bottom: 10px;">
                                    <thead>
                                        <tr>
                                            <th><?php echo _('Required Parameters'); ?></th>
    ...
    "success": "Updated testapihostgroup in the system. Config applied, Nagios Core was restarted."
                ...
                <div class="help-section obj-reference">
                    <h4><span class="label label-success">PUT</span> config/servicegroup <i>or</i> config/servicegroup/&lt;servicegroup_name&gt;</h4>
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            <div class="col-md-5 col-lg-4 col-xl-3">
                                <p><?php echo _('This command updates a current servicegroup.'); ?></p>
                                <table class="table table-condensed table-bordered table-hover" style="margin-bottom: 10px;">
                                    <thead>
                                        <tr>
                                            <th><?php echo _('Required Parameters'); ?></th>
    ...
    "success": "Added check_touch_tmp to the system. Config applied, Nagios Core was restarted."
                ...
                <div class="help-section obj-reference">
                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            <div class="col-md-5 col-lg-4 col-xl-3">
                                <p><?php echo _('This endpoint edits a command object.'); ?></p>
                                <table class="table table-condensed table-bordered table-hover" style="margin-bottom: 10px;">
                                    <thead>
                                        <tr>
                                            <th><?php echo _('Required Parameters'); ?></th>
    ...
    "success": "Added testcontact to the system. Config applied, Nagios Core was restarted."
                ...
                <div class="help-section obj-reference">
                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            <div class="col-md-5 col-lg-4 col-xl-3">
                                <p><?php echo _('This endpoint edits a contact object.'); ?></p>
                                <table class="table table-condensed table-bordered table-hover" style="margin-bottom: 10px;">
                                    <thead>
                                        <tr>
                                            <th><?php echo _('Optional Parameters'); ?></th>
    ...
    "success": "Updated jsmith in the system. Config applied, Nagios Core was restarted."
                ...
                <div class="help-section obj-reference">
                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            <div class="col-md-5 col-lg-4 col-xl-3">
                                <p><?php echo _('This endpoint edits a contact group object.'); ?></p>
                                <table class="table table-condensed table-bordered table-hover" style="margin-bottom: 10px;">
                                    <thead>
                                        <tr>
                                            <th><?php echo _('Optional Parameters'); ?></th>
    ...
    "success": "Added testtimeperiod to the system. Config applied, Nagios Core was restarted."
                ...
                <div class="help-section obj-reference">
                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            <div class="col-md-5 col-lg-4 col-xl-3">
                                <p><?php echo _('This endpoint edits a time period object.'); ?></p>
                                <table class="table table-condensed table-bordered table-hover" style="margin-bottom: 10px;">
                                    <thead>
                                        <tr>
                                            <th><?php echo _('Optional Parameters'); ?></th>
