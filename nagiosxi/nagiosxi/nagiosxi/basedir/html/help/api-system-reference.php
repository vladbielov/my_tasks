                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-7">
                                ...
                                <pre><code id="cmd-system-add-sd">curl -XPOST "<?php echo get_base_url(); ?>api/v1/system/scheduleddowntime?apikey=<?php echo $apikey; ?>&amp;pretty=1" -d "comment=Test downtime creation&amp;start=<?php echo time(); ?>&amp;end=<?php echo (time() + (60 * 10)); ?>&amp;hosts[]=localhost"</code></pre>
